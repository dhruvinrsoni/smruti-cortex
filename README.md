...
- **Global keyboard shortcut** - Ctrl+Shift+P to open popup instantly
...
- **Ctrl+Shift+P**: Quick open popup (focuses first result if available)

### Quick Access
- **Omnibox**: Type `sc ` in address bar, then your search query
- **Toolbar**: Click the brain icon 🧠
- **Keyboard**: Press `Ctrl+Shift+P` to open popup instantly
