...
# --- Ranking-bug report labels (auto-applied by the extension's Report button) ---
gh label create "ranking-bug"            --repo "$REPO" --color "fef2c0" --description "Search ranking issue (auto-generated by Report button)" --force
gh label create "auto-report"            --repo "$REPO" --color "fef2c0" --description "Issue created automatically by an extension flow"        --force
gh label create "sink: ranking-reports"  --repo "$REPO" --color "ededed" --description "Silo label — filter these out of the main issue queue"  --force
gh label create "duplicate?"             --repo "$REPO" --color "cfd3d7" --description "Possible duplicate flagged by the dedupe workflow"      --force
